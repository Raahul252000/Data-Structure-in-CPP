...
{
    node* temp = tail;
    temp -> previous -> next = NULL;  // here we are  breaking the bond by storing NULL in the next of the last 2nd node.
...
int main()
{
    ...
    insert_begin(head,tail,12);
    insert_end(head,tail,14);
    insert_at_anypoint(head,tail,2,20);
    insert_at_anypoint(head,tail,1,25);
